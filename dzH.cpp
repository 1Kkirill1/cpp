...
// представима является числом делящимся на 3,
// иначе напечатать нет
// Необходимо реализовать конечный автомат
//
// Подсказка: состояния - остатки от деления"


// Определяем состояния конечного автомата
enum State {
    REMAINDER_0 = 0, // Остаток 0
...
int dzH() {
     std::cout << "Является ли строка числом делящимся на 3\n";
